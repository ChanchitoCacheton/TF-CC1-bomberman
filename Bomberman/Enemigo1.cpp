...
CEnemigo1::CEnemigo1(int x, int y, int dx, int dy, int dir, int limx, int limy) : CEnemigo(x, y, dx, dy, dir, limx, limy)
{}
CEnemigo1::~CEnemigo1()
{}
void CEnemigo1::pintar(Graphics ^r, Bitmap ^img, Bitmap ^img1)
{
...
void CEnemigo1::mover(int limite_Y)
{
	if (!murio){
		switch (dir)
		{
