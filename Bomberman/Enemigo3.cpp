...
CEnemigo3::CEnemigo3(int x, int y, int dx, int dy, int dir, int limx, int limy) : CEnemigo(x, y, dx, dy, dir, limx, limy)
{}
CEnemigo3::~CEnemigo3()
{}
void CEnemigo3::pintar(Graphics ^r, Bitmap ^img, Bitmap ^img1)
{
...
void CEnemigo3::mover(int limite_Y)
{
	if (!murio){
		switch (dir)
		{
